...
with open('wang_reaction9.txt') as f:
    for line in f.readlines():
        ...
        if not line.startswith("#") and line.split(): 
            ...
            line = line.replace('",','  ]\t\t\t\t')
            line = line.replace(',','\t')
            line = line.replace('falloff_reaction(','\t[ ')
            line = line.replace("kf0 =", '')
            line = line.replace("kf =", '')
            ...
            line = line.replace(" falloff = Troe", 'Troe ')
...
#
#     
with open('vulcan_venot_9.txt', 'w+') as f: f.write(new_str)   
#new_str += three_body    
